...
<h3>You Are Not Logged in Please login first<br><br><br>
  <a href="DAlogin.php">Click Here</a> to login </h3>
</div>
        ...
        <nav class="col-md-2 sidebar" style="background-color: #111a24 ; color: rgb(255, 255, 255)">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="event.php" target="main_content">
                  <i class="fa fa-calendar" aria-hidden="true"></i>
                  Event
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="verifyInstitute.php" target="main_content">
              ...
              <li class="nav-item">
                <a class="nav-link" href="verifyReport.php" target="main_content">
            ...
            <ul class="nav">
              <li class="nav-item">
                <a class="nav-link" href="#" target="main_content">
                  Update
                </a>
              </li>
              <li class="nav-item">
