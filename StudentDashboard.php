<?php include('inc/session.php');
    ...
    <a href="login.php">Click Here</a> to login </h3>
    </div>
...
.sidebar-heading {
  ...
  <body>
    <nav class="navbar sticky-top p-2 " style="background-color: #111a24 ; color: rgb(255, 255, 255); box-shadow: inset -1px 0 0 rgba(0, 0, 0, .1);border-bottom: 1px solid #FFF;">
        <a class="col-sm-2 col-md-2 mr-2" style=" color: rgb(255, 255, 255); font-size: 20px;" href="#"> <i class="fa fa-dashboard"></i> Dashboard</i></a>
        ...
        <nav class="col-md-2 sidebar" style="background-color: #111a24 ; color: rgb(255, 255, 255)">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="ViewEventPS.php" target="main_content">
                  <i class="fa fa-ViewEventPScalendar" aria-hidden="true"></i>
                 View Problem Satement 
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="AddTeamMember.php" target="main_content">
                <i class="fa fa-bookmark" aria-hidden="true"></i>
                 Team Member
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="ReportSubmit.php" target="main_content">
                  <i class="fa fa-address-card" aria-hidden="true"></i>
                  Submit Report
                </a>
              </li>
            </ul>
            <div style="margin-top: 200px; margin-left: 5px; color:#333;" > <i class="fa fa-copyright" aria-hidden="true"></i>Ganesh Kadam</div>
          </div>
        </nav>
