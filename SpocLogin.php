...
<?php
	...
	if($_POST)
	{
		...
		$email_query = mysqli_query($conn, "select * from institute_sopc where SPOC_mail LIKE '$email' ");
        ...
        if($password != $user_data["SPOC_pass"])
		...
		if(!$error)
		{
			...
			//redirect
			header("Location: SpocDashboard.php");
		}
		//else echo "no if";
	}		
?>
    ...
    <div class="container justify-content-center" >
        <div class="card col-sm-12">
            <div class="card-header">
                Institute SPOC login
            </div> <br><br>
            <form action="Spoclogin.php" method="post">
