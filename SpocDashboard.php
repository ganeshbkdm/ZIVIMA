...
<h3>You Are Not Logged in Please login first<br><br><br>
  <a href="SpocLogin.php">Click Here</a> to login </h3>
</div>
        ...
        <nav class="col-md-2 sidebar" style="background-color: #111a24 ; color: rgb(255, 255, 255)">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <a class="nav-link" href="verifyTeam.php" target="main_content">
                    <i class="fa fa-home" aria-hidden="true"></i>
                     Verify Team 
                </a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link" href="viewAllParticipentSPOC.php" target="main_content">
