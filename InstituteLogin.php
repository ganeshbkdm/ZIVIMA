...
<?php
	...
	if($_POST)
	{
		...
		$email_query = mysqli_query($conn, "select * from institute where InMail LIKE '$email' ");
		...
		if(!$error)
		{
			...
			//redirect
			header("Location: InstituteDashboard.php");
		}
		//else echo "no if";
	}		
?>
...
<br><br><br><br>
    ...
    <div class="container justify-content-center" >
        <div class="card col-sm-12">
            ...
            <form action="InstituteLogin.php" method="post">
